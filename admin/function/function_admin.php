...
function Admin_ArticleAdmin() {
    ...
    $array = $tqb->GetArticleList(
            '', $w, array('log_PostTime' => 'DESC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p), false
    );
...
function Admin_PageAdmin() {
    ...
    $array = $tqb->GetPageList(
            '', $w, array('log_PostTime' => 'DESC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p)
    );
...
function Admin_CommentAdmin() {
    ...
    $array = $tqb->GetCommentList(
            '', $w, array('comm_ID' => 'DESC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p)
    );
...
function Admin_MemberAdmin() {
    ...
    $array = $tqb->GetMemberList(
            '', $w, array('mem_ID' => 'ASC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p)
    );
...
function Admin_UploadAdmin() {
    ...
    $array = $tqb->GetUploadList(
            '', $w, array('ul_PostTime' => 'DESC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p)
    );
...
function Admin_TagAdmin() {
    ...
    $array = $tqb->GetTagList(
            '', '', array('tag_ID' => 'ASC'), array(($p->PageNow - 1) * $p->PageCount, $p->PageCount), array('pagebar' => $p)
    );
