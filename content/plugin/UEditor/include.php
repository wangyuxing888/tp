...
function ActivePlugin_UEditor() {
	...
	Add_Filter_Plugin('Filter_Plugin_Html_Util','ueditor_SyntaxHighlighter_print');
...
function ueditor_SyntaxHighlighter_print(){
	...
	global $tqb;
	if(!$tqb->option['CFG_SYNTAXHIGHLIGHTER_ENABLE'])return ;
	echo "\r\n".'document.writeln("<script src=\'' . $tqb->host .'content/plugin/UEditor/third-party/SyntaxHighlighter/shCore.pack.js\' type=\'text/javascript\'></script><link rel=\'stylesheet\' type=\'text/css\' href=\'' . $tqb->host .'content/plugin/UEditor/third-party/SyntaxHighlighter/shCoreDefault.pack.css\'/>");'."\r\n";
...
function ueditor_addscript_begin(){
	global $tqb;
	echo '<script type="text/javascript" src="' . $tqb->host . 'content/plugin/UEditor/ueditor.config.php"></script>';
	echo '<script type="text/javascript" src="' . $tqb->host . 'content/plugin/UEditor/ueditor.all.min.js"></script>';
}
