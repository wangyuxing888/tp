...
window.onload = function () {
    ...
    emotion.SmileyPath = editor.options.emotionLocalization === true ? 'images/' : "<?php echo $bloghost; ?>content/emotion/";
<?php
...
function over( td, srcPath, posFlag ) {
	...
	$G( 'faceReview' ).src = "<?php echo $bloghost;?>admin/image/admin/none.gif";
